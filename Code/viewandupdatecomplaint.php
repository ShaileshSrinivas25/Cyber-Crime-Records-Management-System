...
$category = $subject = $details = $social = $suspect = $dates = $area = $status = $priority = $b_notes = "";
$successMsg = $errorMsg = "";
...
<html>
    ...
    <body >
        ...
        <a href="mycomplaints.php?q=<?php echo $login_user;?>"><h2>>>>Back</h2></a><br><br>
        <div class="table">
          <center>
            <h2 style="font:bold;font-size:45px;">View and Update Complaint&nbsp;<?php echo $c_id; ?></h2><br>
                  ...
                  <option value="0">Please Select</option>
				          ...
				          <textarea name="b_notes" maxlength="100"><?php echo $b_notes;?></textarea><span class="error">* <?php echo $b_notesErr;?></span></td></tr>
				          <tr style="text-align: center;"><td colspan="2"><input class="submit" type="submit" name="submit" value="Update"><br><span class="success"><?php echo $successMsg;?></span><span class="error"><?php echo $errorMsg;?></span></td></tr>
                </table>
			        </form>
          </center>
        </div><br><br><br>
