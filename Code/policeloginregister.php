    ...
    <body>
      <div class="head" >
        <table >
		  ...
		  <div><h2><a href="mainpage.html">>>>Back</a></h2></div><br>
        <div class="table"> 
          <center>
            <a href="mainpage.html"><h1>POLICE LOGIN</h1></a><br><br>
				    <form method="POST" action="#">
				          <table border="6.0" > 
                        <tr><td>&nbsp;&nbsp;Username/Police ID:</td><td> &nbsp;&nbsp;&nbsp;<input type="text" name="username"placeholder="Enter Your User Name" value="<?php echo $username;?>"></tr>
                        ...
                        <tr style="text-align: center;"><td colspan="2"><input type="submit" name="submit" value="Submit" style="height:30px; width: 90px;"></td>
                  </table>
            </form> 					
          </center>
        </div><br><br><br><br>            
